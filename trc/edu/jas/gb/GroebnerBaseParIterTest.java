...
public class GroebnerBaseParIterTest extends TestCase {
    ...
    /**
     * Constructs a <CODE>GroebnerBaseParIterTest</CODE> object.
     * @param name String.
     */
    public GroebnerBaseParIterTest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
        TestSuite suite = new TestSuite(GroebnerBaseParIterTest.class);
        return suite;
    }
    ...
    protected void setUp() {
        ...
        a = b = c = d = e = null;
        bbseq = new GroebnerBaseSeqIter<BigRational>();
        bbpar = new GroebnerBaseParIter<BigRational>(threads);
    }
