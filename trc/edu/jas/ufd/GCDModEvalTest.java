...
public class GCDModEvalTest extends TestCase {
    ...
    public void testModEvalGcd() {
        ...
        for (int i = 0; i < 1; i++) {
            ...
            e = PolyUtil.<ModInteger> baseSparsePseudoRemainder(a, d);
            //System.out.println("e = " + e);
            assertTrue("gcd(a,b) | a" + e, e.isZERO());

            e = PolyUtil.<ModInteger> baseSparsePseudoRemainder(b, d);
            //System.out.println("e = " + e);
    ...
    public void testBaseQR() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            b = a.multiply(c);
            //System.out.println("b  = " + b);
            d = PolyUtil.<ModInteger> baseSparsePseudoRemainder(b, c);
            //System.out.println("d  = " + d);
    ...
    public void testRecursiveQR() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            dr = PolyUtil.<ModInteger> recursiveSparsePseudoRemainder(br, cr);
