...
public class SquarefreeAlgModTest extends TestCase {
    ...
    GenPolynomial<GenPolynomial<AlgebraicNumber<ModInteger>>> ar, br, cr, dr, er;
    ...
    public void testBaseSquarefree() {
        ...
        e = PolyUtil.<AlgebraicNumber<ModInteger>> baseSparsePseudoRemainder(d, c);
    ...
    public void testRecursiveSquarefree() {
        ...
        er = PolyUtil.<AlgebraicNumber<ModInteger>> recursiveSparsePseudoRemainder(dr, cr);
