...
/**
 * TermOrderByName compatibility tests with JUnit. Tests different
 * TermOrders.
 * @author Axel Kramer
 */
...
public class TermOrderByNameCompatTest extends TestCase {
    ...
    public void testTermOrderLexicographic() {
        ...
        GenPolynomialRing<BigInteger> pf = new GenPolynomialRing<BigInteger>(rf,TermOrderByName.Lexicographic, v);
        ...
        assertEquals("( -10 ) x^5 * y^4 * z^2 + 7 x^2 * y^5 * z^3 - 10 x^2 * y * z^5 - 7 x * y^5 * z^4 + 6 x * y^4 * z^3 + 6 x * y^3 * z^3 + 3 x * y^2 * z + y^4 * z - 7 y^2 * z + 2 z^5", p.toString());
    }
    ...
    public void testTermOrderNegativeLexicographic() {
        ...
        // polynomials over integral numbers
        GenPolynomialRing<BigInteger> pf = new GenPolynomialRing<BigInteger>(rf, TermOrderByName.NegativeLexicographic, v);
        ...
        assertEquals("2 z^5 - 7 y^2 * z + y^4 * z + 3 x * y^2 * z + 6 x * y^3 * z^3 + 6 x * y^4 * z^3 - 7 x * y^5 * z^4 - 10 x^2 * y * z^5 + 7 x^2 * y^5 * z^3 - 10 x^5 * y^4 * z^2", p.toString());
    ...
    public void testTermOrderDegreeLexicographic() {
        ...
        String testPolynomial="-10*x^5*y^4*z^2 + 7*x^2*y^5*z^3 - 10*x^2*y*z^5 - 7*x*y^5*z^4 + 6*x*y^4*z^3 + 6*x*y^3*z^3 + 3*x*y^2*z + y^4*z - 7*y^2*z + 2*z^5";
        // polynomials over integral numbers
        GenPolynomialRing<BigInteger> pf = new GenPolynomialRing<BigInteger>(rf, TermOrderByName.DegreeLexicographic, v);
        ...
        assertEquals("( -10 ) x^5 * y^4 * z^2 + 7 x^2 * y^5 * z^3 - 7 x * y^5 * z^4 - 10 x^2 * y * z^5 + 6 x * y^4 * z^3 + 6 x * y^3 * z^3 + y^4 * z + 2 z^5 + 3 x * y^2 * z - 7 y^2 * z", p.toString());
    ...
    public void testTermOrderNegativeDegreeReverseLexicographic() {
        ...
        // polynomials over integral numbers
        GenPolynomialRing<BigInteger> pf = new GenPolynomialRing<BigInteger>(rf, TermOrderByName.NegativeDegreeReverseLexicographic, v);
        ...
        assertEquals("( -7 ) y^2 * z + 3 x * y^2 * z + y^4 * z + 2 z^5 + 6 x * y^3 * z^3 + 6 x * y^4 * z^3 - 10 x^2 * y * z^5 + 7 x^2 * y^5 * z^3 - 7 x * y^5 * z^4 - 10 x^5 * y^4 * z^2", p.toString());
    }
    ...
    public void testTermOrderDegreeReverseLexicographic() {
        ...
        // polynomials over integral numbers
        GenPolynomialRing<BigInteger> pf = new GenPolynomialRing<BigInteger>(rf, TermOrderByName.DegreeReverseLexicographic, v);
	...
	//degrees       11,           10,          10,          8,            8,          7,    5,    5,        4,       3
        assertEquals("( -10 ) x^5 * y^4 * z^2 + 7 x^2 * y^5 * z^3 - 7 x * y^5 * z^4 + 6 x * y^4 * z^3 - 10 x^2 * y * z^5 + 6 x * y^3 * z^3 + y^4 * z + 2 z^5 + 3 x * y^2 * z - 7 y^2 * z", p.toString());    
    }
    ...
    public void testTermOrderNegativeDegreeLexicographic() {
        ...
        // polynomials over integral numbers
        GenPolynomialRing<BigInteger> pf = new GenPolynomialRing<BigInteger>(rf, TermOrderByName.NegativeDegreeLexicographic, v);
        //System.out.println("pf = " + pf);
        ...
        assertEquals("( -7 ) y^2 * z + 3 x * y^2 * z + y^4 * z + 2 z^5 + 6 x * y^3 * z^3 - 10 x^2 * y * z^5 + 6 x * y^4 * z^3 + 7 x^2 * y^5 * z^3 - 7 x * y^5 * z^4 - 10 x^5 * y^4 * z^2", p.toString());
    }
