...
public class GenExteriorPolynomialTest extends TestCase {
  ...
  public void testConstructors() {
    ...
    pppf = new GenExteriorPolynomialRing<GenExteriorPolynomial<GenExteriorPolynomial<BigInteger>>>(
        ppf, wf3);
    // System.out.println("pppf = " + pppf);

    GenExteriorPolynomial<GenExteriorPolynomial<GenExteriorPolynomial<BigInteger>>> ppp =
        pppf.getONE();
    ...
    List<GenExteriorPolynomial<GenExteriorPolynomial<GenExteriorPolynomial<BigInteger>>>> ppgens =
        pppf.generators();
    ...
    pppe =
        new GenExteriorPolynomial<GenExteriorPolynomial<GenExteriorPolynomial<BigInteger>>>(pppf);
  ...
  public void testIterators() {
    ...
    GenExteriorPolynomialRing<BigInteger> pf =
        new GenExteriorPolynomialRing<BigInteger>(rf, "abcdef");
    // System.out.println("pf = " + pf);
  ...
  public void testExample() {
    ...
    GenExteriorPolynomial<BigInteger> emaxd, p1, p2, q1, q2, s, g1, g2, e1, e2, e1dual, e2dual, q,
        qs, qt, g1dual, g2dual, s1, s2;
