...
public class TermOrderOptimizationTest extends TestCase {
    ...
    public void testPolyCoefOptimization() {
        ...
        GenPolynomialRing<GenPolynomial<BigRational>> faci = new GenPolynomialRing<GenPolynomial<BigRational>>(
                        cof, rfac);
        //System.out.println("faci = " + faci);
        List<GenPolynomial<GenPolynomial<BigRational>>> Fi = TermOrderOptimization
                        .permutationOnCoefficients(S, faci, Fo.list);
