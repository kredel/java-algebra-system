...
public class QuotSolvablePolynomialTest extends TestCase {
    ...
    protected void setUp() {
        ...
        WeylRelations<SolvableQuotient<BigRational>> wl = new WeylRelations<SolvableQuotient<BigRational>>(ring);
        wl.generate();
        table = ring.table;
        a = b = c = d = e = null;
    }
        ...
        for (GenPolynomial<SolvableQuotient<BigRational>> x : gens) {
            ...
            for (GenPolynomial<SolvableQuotient<BigRational>> y : gens) {
                ...
                ev = a.leadingBaseCoefficient().num.leadingExpVector()
                                .sum(b.leadingBaseCoefficient().num.leadingExpVector());
                assertTrue("LT(a)*LT(b) == LT(c)", c.leadingBaseCoefficient().num.leadingExpVector().equals(ev));
            }
        }
    ...
    public void testExtendContractWeyl() {
        ...
        QuotSolvablePolynomial<BigRational> ae = (QuotSolvablePolynomial<BigRational>) a.extend(pfe, 0, 0);
    ...
    public void testRecursiveWeyl() {
        ...
        ar = (QuotSolvablePolynomial<BigRational>) PolyUtil.<BigRational> recursive(rsring, ad);
        br = (QuotSolvablePolynomial<BigRational>) PolyUtil.<BigRational> recursive(rsring, bd);
        //System.out.println("ar = " + ar);
        ...
        dr = (QuotSolvablePolynomial<BigRational>) PolyUtil.<BigRational> recursive(rsring, cd);
