...
public class GCDcoFactors<C extends GcdRingElem<C>> implements Serializable {
     ...
     */
    public GCDcoFactors(GenSolvablePolynomial<C> a, GenSolvablePolynomial<C> b, GenSolvablePolynomial<C> ca, GenSolvablePolynomial<C> cb, GenSolvablePolynomial<C> l, GenSolvablePolynomial<C> r) {
        polyA = a;
        polyB = b;
        coA = ca;
        coB = cb;
     ...
     * @return true if left * coA * right = polyA and left * coB * right = polyB.
