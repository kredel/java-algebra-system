 ...
 * algorithms with syzygy computation. The implementaton uses solvable
 * syzygy gcd computation.
...
public class GreatestCommonDivisorSyzygy<C extends GcdRingElem<C>> extends GreatestCommonDivisorAbstract<C> {
    ...
    public GenSolvablePolynomial<GenPolynomial<C>> leftRecursiveUnivariateGcd(
        ...
        List<GenSolvablePolynomial<GenPolynomial<C>>> A = new ArrayList<GenSolvablePolynomial<GenPolynomial<C>>>(2);
        A.add(P);
        A.add(S);
