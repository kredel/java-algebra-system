...
public final class ModLongRing implements ModularRingFactory<ModLong> {
     ...
     */
    public final static java.math.BigInteger MAX_LONG = new java.math.BigInteger( String.valueOf(Long.MAX_VALUE) );


    /** The constructor creates a ModLongRing object 
     * from a long integer as module part. 
    ...
    /** The constructor creates a ModLongRing object 
     * from a BigInteger converted to long as module part. 
