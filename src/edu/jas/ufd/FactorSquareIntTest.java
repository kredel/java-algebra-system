...
public class FactorSquareIntTest extends TestCase {
...
/**
 * Constructs a <CODE>FactorSquareIntTest</CODE> object.
 * @param name String.
 */
 public FactorSquareIntTest(String name) {
     super(name);
 }
 ...
 */ 
 public static Test suite() {
     TestSuite suite= new TestSuite(FactorSquareIntTest.class);
     return suite;
 }
