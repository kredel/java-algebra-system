...
public class FactorSquareRatTest extends TestCase {
...
/**
 * Constructs a <CODE>FactorSquareRatTest</CODE> object.
 * @param name String.
 */
 public FactorSquareRatTest(String name) {
     super(name);
 }
 ...
 */ 
 public static Test suite() {
     TestSuite suite= new TestSuite(FactorSquareRatTest.class);
     return suite;
 }
