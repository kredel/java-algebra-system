...
public class FactorSquareModTest extends TestCase {
...
/**
 * Constructs a <CODE>FactorSquareModTest</CODE> object.
 * @param name String.
 */
 public FactorSquareModTest(String name) {
     super(name);
 }
 ...
 */ 
 public static Test suite() {
     TestSuite suite= new TestSuite(FactorSquareModTest.class);
     return suite;
 }
