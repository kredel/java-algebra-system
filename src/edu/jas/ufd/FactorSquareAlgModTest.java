...
public class FactorSquareAlgModTest extends TestCase {
...
/**
 * Constructs a <CODE>FactorSquareAlgModTest</CODE> object.
 * @param name String.
 */
 public FactorSquareAlgModTest(String name) {
     super(name);
 }
 ...
 */ 
 public static Test suite() {
     TestSuite suite= new TestSuite(FactorSquareAlgModTest.class);
     return suite;
 }
 ...
 */
 public void testBaseSquarefree() {
     ...
     System.out.println("d  = " + d);
     System.out.println("c  = " + c);
     assertTrue("isSquarefree(c) " + c, ufd.isSquarefree(c) );
 ...
 */
 public void testRecursiveSquarefree() {
     ...
     cr = ufd.recursiveSquarefreePart(cr);
     dr = ufd.recursiveSquarefreePart(dr);
     System.out.println("dr  = " + dr);
     System.out.println("cr  = " + cr);
     assertTrue("isSquarefree(cr) " + cr, ufd.isRecursiveSquarefree(cr) );
