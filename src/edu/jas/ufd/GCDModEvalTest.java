 ...
 */
 public void testBaseSquarefree() {
     ...
     e = PolyUtil.<ModInteger>basePseudoRemainder(d,c);
     //e = PolyUtil.<ModInteger>basePseudoRemainder(c,d);
     //System.out.println("e  = " + e);
 ...
 */
 public void testBaseSquarefreeFactors() {
     ...
     e = dfac.getONE();
     for ( Map.Entry<GenPolynomial<ModInteger>,Long> m : sfactors.entrySet() ) {
         GenPolynomial<ModInteger> p = m.getKey();
         long j = m.getValue();
         for ( int i = 0; i < j; i++ ) {
             e = e.multiply(p);
         }
     ...
     //System.out.println("e  = " + e);
     e = PolyUtil.<ModInteger>basePseudoRemainder(d,e);
     assertTrue("PROD squarefreefactors(aabbbc) | aabbbc " + e, e.isZERO() );

     e = dfac.getONE();
     for ( GenPolynomial<ModInteger> p : sfactors.keySet() ) {
         e = e.multiply(p);
     }
     //System.out.println("e  = " + e);

     //e = PolyUtil.<ModInteger>basePseudoRemainder(e,c);
     e = PolyUtil.<ModInteger>basePseudoRemainder(c,e);
     //System.out.println("e  = " + e);
 ...
 */
 public void testRecursiveSquarefreeFactors() {
     ...
     er = rfac.getONE();
     for ( Map.Entry<GenPolynomial<GenPolynomial<ModInteger>>,Long> m : sfactors.entrySet() ) {
         GenPolynomial<GenPolynomial<ModInteger>> p = m.getKey();
         long j = m.getValue();
         for ( int i = 0; i < j; i++ ) {
             er = er.multiply(p);
         }
     ...
     //System.out.println("er  = " + er);
     er = PolyUtil.<ModInteger>recursivePseudoRemainder(dr,er);
     assertTrue("PROD squarefreefactors(aabbbc) | aabbbc " + er, er.isZERO() );


     er = rfac.getONE();
     for ( GenPolynomial<GenPolynomial<ModInteger>> p : sfactors.keySet() ) {
         er = er.multiply(p);
     }
     //System.out.println("er  = " + er);

     //er = PolyUtil.<ModInteger>recursivePseudoRemainder(er,cr);
     er = PolyUtil.<ModInteger>recursivePseudoRemainder(cr,er);
     //System.out.println("er  = " + er);
