...
/**
 * Array list power series implementation.
 * @param <C> ring element type
 * @author Heinz Kredel
 */

public class ArrayPowerSeries<C extends RingElem<C>> 
     ...
     * Constructor.
     */
    public ArrayPowerSeries(Coefficients<C> lazyCoeffs) {
     ...
     * Constructor.
     */
    public ArrayPowerSeries(Coefficients<C> lazyCoeffs, HashMap<Integer,C> coeffs) {
        if ( lazyCoeffs == null) {
     ...
     */
    public ArrayPowerSeries<C> reductum() {
        return new ArrayPowerSeries<C>(
                   new Coefficients<C>() {
                       public C get(int i) {
                              return ArrayPowerSeries.this.coefficient(i+1);
                       }
                   }
                                       );
    }
     ...
     */
    public ArrayPowerSeries<C> prepend(final C h) {
        return new ArrayPowerSeries<C>(
                   new Coefficients<C>() {
                       public C get(int i) {
                              if ( i == 0 ) {
     ...
     * @return new power series.
     */
    public ArrayPowerSeries<C> select(final Selector<? super C> sel) {
        return new ArrayPowerSeries<C>(
                   new Coefficients<C>() {
                       int pos = 0;
                       public C get(int i) {
                           ...
                           //  }
                              C c = null;
                              do { 
                                   c = ArrayPowerSeries.this.coefficient( pos++ );
                              } while( !sel.select(c));
                              return c;
                       }
                   }
     ...
     * @return new power series.
     */
    public <D extends RingElem<D>> ArrayPowerSeries<D> map(final UnaryFunctor<? super C,D> f) {
        return new ArrayPowerSeries<D>(
                   new Coefficients<D>() {
                       public D get(int i) {
                              return f.eval( ArrayPowerSeries.this.coefficient(i) );
                       }
                   }
                                       );
    }
    ...
    public <C2 extends RingElem<C2>, D extends RingElem<D>> 
        ...
        return new ArrayPowerSeries<D>(
                   new Coefficients<D>() {
                       public D get(int i) {
                              return f.eval( ArrayPowerSeries.this.coefficient(i), ps.coefficient(i) );
                       }
                   }
                                       );
    }
    ...
    public static <C extends RingElem<C>> 
        ArrayPowerSeries<C> fixPoint(PowerSeriesMap<C> map) {
             ArrayPowerSeries<C> ps1 = new ArrayPowerSeries<C>();
             ArrayPowerSeries<C> ps2 = (ArrayPowerSeries<C>) map.map(ps1);
     ...
     * @return this + ps.
     */
    public ArrayPowerSeries<C> sum(ArrayPowerSeries<C> ps) {
     ...
     * @return this - ps.
     */
    public ArrayPowerSeries<C> subtract(ArrayPowerSeries<C> ps) {
     ...
     * @return this * c.
     */
    public ArrayPowerSeries<C> multiply(C c) {
     ...
     * @return - this.
     */
    public ArrayPowerSeries<C> negate() {
     ...
     * @return this * ps.
     */
    public ArrayPowerSeries<C> multiply( final PowerSeries<C> ps ) {
        return new ArrayPowerSeries<C>(
                   new Coefficients<C>() {
                       public C get(int i) {
     ...
     */
    public ArrayPowerSeries<C> inverse() {
        return new ArrayPowerSeries<C>(
                   new Coefficients<C>() {
                       public C get(int i) {
     ...
     * @return this * ps^{-1}.
     */
    public ArrayPowerSeries<C> divide( PowerSeries<C> ps ) {
	if ( ! ps.isUnit() ) {
