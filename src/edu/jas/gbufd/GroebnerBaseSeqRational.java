...
public class GroebnerBaseSeqRational<C extends BigRational> 
    extends GroebnerBaseSeq<BigRational>  {
     ...
     */
    public List<GenPolynomial<BigRational>> 
        GB( int modv, 
     ...
     */
    public List<GenPolynomial<BigRational>> 
        minimalGB(List<GenPolynomial<BigRational>> Gp) {  
        if ( Gp == null || Gp.size() <= 1 ) {
            return Gp;
        }
        // remove zero polynomials
        List<GenPolynomial<BigRational>> G
            = new ArrayList<GenPolynomial<BigRational>>( Gp.size() );
