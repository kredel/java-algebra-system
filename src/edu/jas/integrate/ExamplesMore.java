...
public class ExamplesMore {
	 ...
	 * @param r
	 *            rational function
	 * @return Integral container, such that integrate(r) = sum_i(g_i) + sum_j( an_j
	 *         log(hd_j) )
	 */
	...
	public static void exampleCzichwoski() {
		...
		QuotientRing<BigRational> qfac = new QuotientRing<BigRational>(fac);
		ElementaryIntegration<BigRational> eIntegratorCzi = new ElementaryIntegrationCzichowski<BigRational>(br);
	...
	public static void exampleBernoulli() {
		...
		QuotientRing<BigRational> qfac = new QuotientRing<BigRational>(fac);
		ElementaryIntegration<BigRational> eIntegratorBer = new ElementaryIntegrationBernoulli<BigRational>(br);
