...
public class RCGroebnerBasePseudoSeq<C extends RegularRingElem<C>> 
       extends RGroebnerBaseSeq<C>  {


    private static final Logger logger = Logger.getLogger(RCGroebnerBasePseudoSeq.class);
     ...
     */
    public RCGroebnerBasePseudoSeq(RingFactory<C> rf) {
