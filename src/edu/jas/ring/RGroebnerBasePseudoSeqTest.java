...
public class RGroebnerBasePseudoSeqTest extends TestCase {
    ...
    //private static final Logger logger = Logger.getLogger(RGroebnerBasePseudoSeqTest.class);
 ...
 */
 ...
 public void xtestTrinks7() {
     ...
     GroebnerBase<Product<BigInteger>> 
         bbri = new RGroebnerBasePseudoSeq<Product<BigInteger>>( pfac );
