...
/**
 * Constructs a <CODE>TensorTest</CODE> object.
 * @param name String.
 */
 ...
 */ 
 public static Test suite() {
     TestSuite suite= new TestSuite(TensorTest.class);
     return suite;
   }
   ...
   TensorRing<BigRational> fac;
   GenPolynomialRing<BigRational> mfac;
   List<GenPolynomial<BigRational>> F;

   Tensor< BigRational > a;
   Tensor< BigRational > b;
   Tensor< BigRational > c;
   Tensor< BigRational > d;
   Tensor< BigRational > e;
   ...
   protected void setUp() {
       ...
       fac = new TensorRing<BigRational>( id );
       F = null;
   }
